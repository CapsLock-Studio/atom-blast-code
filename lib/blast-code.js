...
docReady(function () {
    ...
    function getPosition() {
        ...
        for (var i = 0; i < currentInput.length; ++i) {
            if ( typeof(currentInput[i]) === "object" ) {
                if (currentInput[i].style.display !== "none") {
                    resultObject = currentInput[i].shadowRoot.childNodes[2].getElementsByClassName('hidden-input')[0];
                    break;
                }
            }
        }
        ...
        return resultObject.getClientRects()[0];
    }
